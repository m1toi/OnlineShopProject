...
class MostAbundantStrategyTest {
    ...
    @Test
    void testSelectLocations_AllocatesCorrectStock() {
        ...
        assertEquals(location2, allocation.getLocation());
